...
def get_binary_mnist_dataloader(
    ...
    dataset = MNIST(root=path, train=train, download=True, transform=mnist_xforms)
    ...
    loader = DataLoader(dataset, sampler=SubsetRandomSampler(idxs), batch_size=bs)
